...
# Instanciamos
Tomas = Perros('Tom', 27)
print (Tomas.nombre) # Imprimimos el nombre de Tomas. Se hace a través de getter, que en este caso, como esta luego de property, lo toma como el primer método.
